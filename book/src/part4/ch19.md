...
3. `statusbar_idle`(state=idle,priority=900,同 region)在 `:32`:正则匹配 state Idle 或 Done,或含 `Tab agents | Ctrl+O expand`、`Ask Octos to change code`。
