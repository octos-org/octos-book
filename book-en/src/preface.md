...
- Helpful but optional: elementary Rust. Chapter 2 uses traits and enums; Chapter 12 uses async/await. If Rust is new to you, do not stop here: Chapters 1-2 slow down on purpose, language details are explained in sidebars and comments where they appear, and you can skip them without losing the thread.
...
Path A: Rust beginner (learning Rust and agent engineering through one real, large project)
