...
- Issue #489 (M6.2 typed retry bucket) and the #2172 / #2174 commit messages: first-hand motivation for this chapter's state machine and the two self-healing cases.
