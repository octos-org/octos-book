...
- Landlock documentation and the seccomp BPF manual (`man 2 seccomp`): the two kernel mechanisms applied by the helper that `crates/octos-agent/src/sandbox/landlock.rs` delegates to
